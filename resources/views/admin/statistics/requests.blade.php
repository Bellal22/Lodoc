...
<div id="page-wrapper">
    ...
    <input type="hidden" id="idele" value="{{ Session::get('id') }}" >
        <el-table :data="tableData" style="width: 90%">
            ...
            <el-table-column prop="name" label="الأسم" width="150">
            </el-table-column>
            ...
            <el-table-column
                ...
                <template slot-scope="scope">
                    <el-button
                            size="mini"
                            type="success"
                            @click="handleActivation(scope.$index,scope.row) "
                            >الموافقة</el-button>
                    <el-button
                            size="mini"
                            type="danger"
                            @click="DeleteFromTableData(scope.$index,scope.row)"
                            >الرفض</el-button>
                </template>
            </el-table-column>
<?php
...
<script src={{asset("js/adminpanel-requests.js")}}></script>
<?php
}
?>