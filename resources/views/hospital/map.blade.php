...
<div id="page-wrapper">
    <div id="app">
    <input type="hidden" class="form-control" id="getlog" onclick="toggleBounce(event)" readonly  placeholder="lng" value="{{$db->long}}"  >
    <input type="hidden" class="form-control" id="getlat" onclick="toggleBounce(event)" readonly  placeholder="lng" value="{{$db->lat}}">
...
<html>
  ...
  <body> -->
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAPBKiqoICaSGhyF6A7D9b0aLt2Cc13PK0&libraries=places&callback=initAutocomplete"
         async defer></script>-->
  </body> 
</html>
  </body>
