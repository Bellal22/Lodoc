    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li><a href={{url('hospital/info')}}><i class="fa fa-address-book"></i> المستخدمين</a></li>
                <li><a href={{url('hospital/statistics')}}><i class="fa fa-product-hunt"></i> الأحصائيات </a></li>
                <li><a href={{url('hospital/editdata')}}><i class="fa fa-address-book"></i> تعديل</a></li>
                <li><a href={{url('hospital/bankaccount')}}><i class="fa fa-credit-card"></i> الحسابات البنكية </a>
                <li><a href={{url('hospital/location/'.Session('id'))}}><i class="fa fa-credit-card"></i> اضافة خريطة للمكان </a>
                </li>
