...
class managerController extends controller
{
    ...
    public function index()
    {
        if (Auth::user()->can('manager.view')) {
            $managers = User::all();
            return view('admin.statistics.index', compact('managers'));
        }
    ...
    public function create()
    {
        // if (Auth::user()->can('manager.create')){
            $roles = Role::all();
            return view('admin.statistics.create',compact('roles'));
        // }
        // return redirect()->back();
    }
...
//        Admin::find($id)->roles()->sync($request->role);
    ...
    public function edit($id)
    {
        if (Auth::user()->can('manager.update')) {
            ...
            $roles = Role::all();
            return view('admin.statistics.edit', compact('manager', 'roles'));
        }
        return redirect()->back();
    }
